...
✅ See AUTH_README.md for detailed auth documentation
...
See AUTH_README.md for detailed authentication flow.
...
For authentication-specific documentation, see AUTH_README.md.
